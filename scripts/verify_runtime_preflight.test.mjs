...
test('only exact-host GETs; private token removed; only sanitized report printed', async () => {
 ...
 assert.deepEqual(calls,['https://autobott-azl4.onrender.com/api/health','https://autobott-azl4.onrender.com/api/session/status','https://autobott-azl4.onrender.com/api/health','https://autobott-azl4.onrender.com/api/safety','https://autobott-azl4.onrender.com/api/account/positions','https://autobott-azl4.onrender.com/api/positions/open','https://autobott-azl4.onrender.com/api/account/orders','https://autobott-azl4.onrender.com/api/health']);
