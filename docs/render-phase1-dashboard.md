...
- `ALPACA PAPER | LIVE MARKET TRADING | REAL MONEY OFF | ORDER PLACEMENT CONFIG DISABLED`
- `ALPACA PAPER | LIVE MARKET TRADING | REAL MONEY OFF | RUNTIME EXECUTION PAUSED`
- `ALPACA PAPER | LIVE MARKET TRADING | REAL MONEY OFF | LIVE PAPER EXECUTION ARMED`
- Check `/api/safety`
