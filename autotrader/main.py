...
def main():
    ...
    while True:
        ...
        if clock.is_open or (
            ...
            # Leave pre-open wait loop and enter the active market loop below.
            break
            ...
            for signal in signals:
                ...
                try:
                    ...
                    open_trade_meta[option_symbol] = {
                        ...
                        "contract_spread_pct": round(float(entry_result.get("submit_spread_pct", 0.0) or 0.0), 4),
                        "selected_contract_rank": contract.get("selected_contract_rank", ""),
                        "selected_contract_score": contract.get("selected_contract_score", ""),
                        "contract_quality_reason": contract.get("contract_quality_reason", ""),
                        "contract_strike_distance_pct": contract.get("contract_strike_distance_pct", ""),
                        "contract_delta_abs": contract.get("contract_delta_abs", contract.get("delta_abs", "")),
                        "contract_bid": contract.get("contract_bid", contract.get("bid_price", "")),
                        "contract_ask": contract.get("contract_ask", contract.get("ask_price", "")),
                        "contract_open_interest": contract.get("contract_open_interest", contract.get("open_interest", "")),
                        "contract_daily_volume": contract.get("contract_daily_volume", contract.get("daily_volume", "")),
            ...
            if exit_reason:
                ...
                try:
                    ...
                    trade_row = {
                        ...
                        "selected_contract_rank": meta.get("selected_contract_rank", ""),
                        "selected_contract_score": meta.get("selected_contract_score", ""),
                        "contract_quality_reason": meta.get("contract_quality_reason", ""),
                        "contract_strike_distance_pct": meta.get("contract_strike_distance_pct", ""),
                        "contract_delta_abs": meta.get("contract_delta_abs", ""),
                        "contract_bid": meta.get("contract_bid", ""),
                        "contract_ask": meta.get("contract_ask", ""),
                        "contract_open_interest": meta.get("contract_open_interest", ""),
                        "contract_daily_volume": meta.get("contract_daily_volume", ""),
