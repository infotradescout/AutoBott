...
LOSS_THROTTLE_MIN_VOLATILITY_SCORE  = 2.0
...
MAX_NON_CORE_ENTRIES_PER_DAY        = 20
NON_CORE_MIN_SIGNAL_SCORE           = 8.0
...
MAX_REENTRIES_PER_TICKER = 5
TICKER_ROUNDTRIP_COOLDOWN_MINUTES = 10
MAX_ALPACA_TRUTH_ROUNDTRIPS_PER_TICKER_PER_DAY = 5
MAX_ALPACA_BUY_ORDERS_PER_TICKER_PER_DAY = 5
