...
ADAPTIVE_LOSS_MIN_SIGNAL_SCORE      = 7.8
ADAPTIVE_LOSS_MIN_DIRECTION_SCORE   = 0.65
ADAPTIVE_LOSS_MAX_SPREAD_PCT        = 4.0
ADAPTIVE_LOSS_CAUSE_WINDOW          = 12
ADAPTIVE_LOSS_SIGNAL_SCORE_ADD_PER_LOSS = 0.15
ADAPTIVE_LOSS_MAX_SIGNAL_SCORE      = 9.2
ADAPTIVE_LOSS_DIRECTION_ADD_PER_WRONG = 0.05
ADAPTIVE_LOSS_MAX_DIRECTION_SCORE   = 0.85
ADAPTIVE_LOSS_EXECUTION_MAX_SPREAD_PCT = 3.0
...
ADAPTIVE_LOSS_REQUIRE_MOMENTUM_AFTER_LOSSES = 2
...
MAX_TOTAL_OPEN_PREMIUM_USD          = 4500.0
