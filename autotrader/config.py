...
ENABLE_ALPACA_TRUTH_LOSS_GUARD      = False
...
LOSS_THROTTLE_MIN_VOLATILITY_SCORE  = 4.0
...
EXECUTION_MIN_RVOL_AFTER_IGNORE = 0.50
ATR_PCT_MIN               = 0.20
VWAP_NEUTRAL_BAND_PCT     = 0.05
MOVEMENT_FORCE_MIN_PCT    = 0.005
MOVEMENT_WEAK_VWAP_MULT   = 1.00

DIRECTION_CONVICTION_MIN  = 0.15  # scanner discovery threshold; execution gates stay stricter
DIRECTION_MIN_ALIGNED_VOTES = 2   # scanner discovery threshold; execution gates stay stricter
...
MIN_SIGNAL_SCORE          = 2.5   # scanner discovery floor; execution gates stay stricter
...
OPENING_ENTRY_MAX_QUOTE_SPREAD_PCT = 20.0
MAX_ENTRY_SLIPPAGE_PCT    = 5.0
MAX_FILL_SLIPPAGE_PCT     = 999.0
ENABLE_FILL_SLIPPAGE_IMMEDIATE_CLOSE = False
REENTRY_COOLDOWN_LOSS_MINUTES      = 0
...
ENTRY_CONFIRM_BYPASS_MIN_SIGNAL_SCORE  = 12.0
ENTRY_CONFIRM_MOMENTUM_THRESHOLD_PCT   = 0.18
ENABLE_FRESH_TAPE_DIRECTION_GUARD      = False
...
FAST_START_MIN_DIRECTION_SCORE         = 0.20
# Runtime fast-start entries relax/ignore this after RVOL_RELAX_AFTER/RVOL_IGNORE_AFTER.
FAST_START_MIN_RVOL                    = 0.00
FAST_START_MIN_ABS_ROC_PCT             = 0.00
FAST_START_MIN_VWAP_DISTANCE_PCT       = 0.00
OPENING_FAST_START_MIN_SIGNAL_SCORE    = 9.0
OPENING_FAST_START_MIN_DIRECTION_SCORE = 0.20
OPENING_FAST_START_MIN_RVOL            = 0.00
OPENING_FAST_START_MIN_ABS_ROC_PCT     = 0.00
OPENING_FAST_START_MIN_VWAP_DISTANCE_PCT = 0.00
...
TICKER_ROUNDTRIP_COOLDOWN_MINUTES = 0
...
QUICK_LOSER_REENTRY_COOLDOWN_MINUTES = 0
