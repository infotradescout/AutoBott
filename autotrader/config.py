...
MAX_SAME_DIRECTION_POSITIONS        = 999
...
# Entry accuracy doctrine:
# Trade flow can be loosened through RVOL, but direction must stay strict.
DIRECTION_CONVICTION_MIN  = 0.50
DIRECTION_MIN_ALIGNED_VOTES = 4
DIRECTION_FAST_ROC_PERIOD  = 5
...
MIN_SIGNAL_SCORE          = 5.8
VOLATILITY_PRIORITY_WEIGHT = 3.0
...
ENTRY_CONFIRM_MOMENTUM_THRESHOLD_PCT   = 0.05
FAST_START_MIN_SIGNAL_SCORE            = 6.4
FAST_START_MIN_DIRECTION_SCORE         = 0.60
FAST_START_MIN_RVOL                    = 0.10
FAST_START_MIN_ABS_ROC_PCT             = 0.05
FAST_START_MIN_VWAP_DISTANCE_PCT       = 0.03
