...
ADAPTIVE_LOSS_MIN_SIGNAL_SCORE      = 6.8
ADAPTIVE_LOSS_MIN_DIRECTION_SCORE   = 0.45
ADAPTIVE_LOSS_MAX_SPREAD_PCT        = 6.0
ADAPTIVE_LOSS_CAUSE_WINDOW          = 12
ADAPTIVE_LOSS_SIGNAL_SCORE_ADD_PER_LOSS = 0.05
ADAPTIVE_LOSS_MAX_SIGNAL_SCORE      = 8.2
ADAPTIVE_LOSS_DIRECTION_ADD_PER_WRONG = 0.03
ADAPTIVE_LOSS_MAX_DIRECTION_SCORE   = 0.70
ADAPTIVE_LOSS_EXECUTION_MAX_SPREAD_PCT = 5.0
...
ADAPTIVE_LOSS_REQUIRE_MOMENTUM_AFTER_LOSSES = 4
ADAPTIVE_LOSS_MIN_ABS_ROC_PCT       = 0.06
ADAPTIVE_LOSS_MIN_RVOL              = 0.15
ADAPTIVE_LOSS_BLOCK_TICKER_AFTER_LOSSES = 3
