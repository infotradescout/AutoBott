...
MIN_OPTION_OPEN_INTEREST = _env_int("MIN_OPTION_OPEN_INTEREST", 25)
MIN_OPTION_DAILY_VOLUME = _env_int("MIN_OPTION_DAILY_VOLUME", 5)
MAX_OPTION_SPREAD_PCT = _env_float("MAX_OPTION_SPREAD_PCT", 30.0)
ENABLE_OPTION_LIQUIDITY_RELAX = _env_bool("ENABLE_OPTION_LIQUIDITY_RELAX", True)
OPTION_CONTRACTS_ALLOW_LIVE_FALLBACK = _env_bool("OPTION_CONTRACTS_ALLOW_LIVE_FALLBACK", False)
MIN_DTE_TRADING_DAYS = _env_int("MIN_DTE_TRADING_DAYS", 1)
MAX_DTE_TRADING_DAYS = _env_int("MAX_DTE_TRADING_DAYS", 2)
MIN_OPTION_OPEN_INTEREST_0DTE = _env_int("MIN_OPTION_OPEN_INTEREST_0DTE", 50)
...
ENTRY_CONFIRM_BYPASS_MIN_SIGNAL_SCORE = _env_float("ENTRY_CONFIRM_BYPASS_MIN_SIGNAL_SCORE", 7.5)
