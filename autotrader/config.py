...
DIRECTION_CONVICTION_MIN  = 0.75  # require directional consensus before risking premium
DIRECTION_MIN_ALIGNED_VOTES = 5   # require at least N directional votes to agree
...
MIN_SIGNAL_SCORE          = 8.4   # edge-mode floor: fewer trades, higher setup quality
