...
ENABLE_HTF_CONFIRM = _env_bool("ENABLE_HTF_CONFIRM", False)
HTF_TIMEFRAME = _env_str("HTF_TIMEFRAME", "15m")
HTF_LOOKBACK_BARS = _env_int("HTF_LOOKBACK_BARS", 30)
ENABLE_ORDER_FLOW_FILTER = _env_bool("ENABLE_ORDER_FLOW_FILTER", False)
...
MIN_SIGNAL_SCORE = _env_float("MIN_SIGNAL_SCORE", 3.5)
...
VIX_MAX = _env_float("VIX_MAX", 80.0)
...
SCAN_DAILY_BARS = 30
RVOL_MIN = _env_float("RVOL_MIN", 1.0)
ATR_PCT_MIN = 1.5
...
IV_RANK_MIN = 20.0
IV_RANK_MAX = _env_float("IV_RANK_MAX", 75.0)
...
MIN_OPTION_OPEN_INTEREST = _env_int("MIN_OPTION_OPEN_INTEREST", 100)
MIN_OPTION_DAILY_VOLUME = _env_int("MIN_OPTION_DAILY_VOLUME", 20)
MAX_OPTION_SPREAD_PCT = _env_float("MAX_OPTION_SPREAD_PCT", 35.0)
