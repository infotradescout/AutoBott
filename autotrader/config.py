...
MAX_NON_CORE_ENTRIES_PER_DAY        = 8
...
OPENING_MAX_NEW_ENTRY_ATTEMPTS_PER_LOOP      = 10
MAX_NEW_ENTRY_ATTEMPTS_PER_LOOP              = 10
...
REENTRY_COOLDOWN_LOSS_MINUTES      = 5
STOP_LOSS_REENTRY_COOLDOWN_MINUTES = 5
...
MAX_OPTION_PREMIUM_TO_UNDERLYING_PCT = 8.0
MAX_OPTION_STRIKE_DISTANCE_PCT       = 8.0
...
MAX_ENTRIES_PER_TICKER_PER_DAY = 4
MAX_REENTRIES_PER_TICKER = 0
TICKER_ROUNDTRIP_COOLDOWN_MINUTES = 5
MAX_ALPACA_TRUTH_ROUNDTRIPS_PER_TICKER_PER_DAY = 4
MAX_ALPACA_BUY_ORDERS_PER_TICKER_PER_DAY = 4
ALPACA_BUY_ORDER_CAP_COUNTS_CANCELED = False
ALPACA_CANCELED_BUY_ORDER_COOLDOWN_MINUTES = 10
QUICK_LOSER_MAX_HOLD_MINUTES         = 4
QUICK_LOSER_REENTRY_COOLDOWN_MINUTES = 5
