...
ENABLE_EXECUTION_EVIDENCE_GATE     = True
...
ENABLE_REPLAY_EDGE_MODEL_GATE      = True
...
OPENING_STRICT_MIN_SIGNAL_SCORE              = 8.8
...
DIRECTION_CONVICTION_MIN  = 0.80  # require clear directional agreement before risking capital
DIRECTION_MIN_ALIGNED_VOTES = 5   # reject mixed/choppy vote stacks
...
MIN_SIGNAL_SCORE          = 8.5   # scanner discovery floor; execution gates stay stricter
