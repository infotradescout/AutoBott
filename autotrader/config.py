...
# --- Basket/runner manager ---
ENABLE_BASKET_MANAGER = _env_bool("ENABLE_BASKET_MANAGER", True)
BASKET_HARVEST_UNREALIZED_USD = _env_float("BASKET_HARVEST_UNREALIZED_USD", 40.0)
BASKET_LAGGARD_CUT_PCT = _env_float("BASKET_LAGGARD_CUT_PCT", -0.12)
BASKET_WINNER_HARVEST_MIN_PCT = _env_float("BASKET_WINNER_HARVEST_MIN_PCT", 0.25)
BASKET_WINNER_LOCK_FLOOR_PCT = _env_float("BASKET_WINNER_LOCK_FLOOR_PCT", 0.05)

ENABLE_RUNNER_MODE = _env_bool("ENABLE_RUNNER_MODE", True)
RUNNER_PROMOTE_PCT = _env_float("RUNNER_PROMOTE_PCT", 0.35)
RUNNER_PROTECT_FLOOR_PCT = _env_float("RUNNER_PROTECT_FLOOR_PCT", 0.20)
RUNNER_MAX_CONCURRENT = _env_int("RUNNER_MAX_CONCURRENT", 1)
RUNNER_DISABLE_AFTER_TIME = _env_str("RUNNER_DISABLE_AFTER_TIME", "15:00")
NON_RUNNER_FLATTEN_TIME = _env_str("NON_RUNNER_FLATTEN_TIME", "15:15")
