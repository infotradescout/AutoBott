...
OPTION_CONTRACT_REQUEST_INTERVAL_SECONDS = 0.25
OPTION_QUOTE_REQUEST_INTERVAL_SECONDS    = 0.18
OPTION_QUOTE_SELECTION_LIMIT             = 16
ENABLE_OPTION_CONTRACT_DETAIL_ENRICHMENT = False
OPTION_CONTRACT_DETAIL_ENRICH_LIMIT      = 6
STALE_OPEN_META_PRUNE_GRACE_SECONDS      = 180
