...
DIRECTION_CONVICTION_MIN  = 0.20  # require directional consensus without starving the bot
DIRECTION_MIN_ALIGNED_VOTES = 2   # require at least N directional votes to agree
...
ENTRY_CONFIRM_BYPASS_MIN_SIGNAL_SCORE  = 6.0
ENTRY_CONFIRM_MOMENTUM_THRESHOLD_PCT   = 0.04
