...
ENABLE_ADAPTIVE_LOSS_ENTRY_GATES    = False
...
STOP_LOSS_USD          = 90.0
STOP_LOSS_PCT          = 0.12
IMMEDIATE_TAKE_PROFIT_PCT = 0.35
...
DIRECTION_CONVICTION_MIN  = 0.15  # discovery-level floor; don't deadlock entries
...
MIN_SIGNAL_SCORE          = 2.5   # permissive floor; let entry logic operate
...
OPENING_ENTRY_MAX_QUOTE_SPREAD_PCT = 8.0
MAX_ENTRY_SLIPPAGE_PCT    = 1.5
MAX_FILL_SLIPPAGE_PCT     = 2.5
...
VIXW_TIME_STOP_MIN_PROGRESS_PCT        = 0.05
VIXW_EMERGENCY_BID_COLLAPSE_PCT        = 0.50
VIXW_ENTRY_BLOCK_AFTER_OPEN_MINUTES    = 30
VIXW_NO_NEW_ENTRIES_AFTER              = "15:45"
VIXW_MAX_QUOTE_AGE_SECONDS             = 60
VIXW_MIN_OPTION_VOLUME                 = 0
VIXW_MIN_OPTION_OPEN_INTEREST          = 0
VIXW_ACCELERATING_ROC_MIN              = 0.05
VIXW_DECELERATION_TOLERANCE            = 0.02
